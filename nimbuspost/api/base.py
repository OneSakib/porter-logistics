"""Base API class for NimbusPost"""

import requests
from typing import Dict, Optional, Any
from nimbuspost.auth import EShopBoxAuth
from nimbuspost.exceptions import APIError, RateLimitError, NotFoundError
...
class BaseAPI:
    ...
    def __init__(self, workspace: str, auth: EShopBoxAuth):
        ...
        Args:
            workspace: NimbusPost workspace name
            auth: Authentication handler
        """
        self.workspace = workspace
        self.auth = auth
        self.base_url = f"https://{workspace}.myeshopbox.com"
        self.eshopbox_url = f"https://{workspace}.nimbuspost.com"
